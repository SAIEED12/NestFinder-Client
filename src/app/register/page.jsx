...
export default function Register() {
  ...
  const inputClassName = "w-full px-3 py-2 text-sm rounded-xl border border-zinc-200 dark:border-zinc-700 bg-white dark:bg-zinc-800 text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-[#E05638] focus:border-transparent transition-all";
    ...
    <main className="min-h-[calc(100vh-4rem)] flex items-center justify-center bg-slate-50/50 px-6 py-12 dark:bg-zinc-950 transition-colors duration-200">
      <div className="w-full max-w-md bg-white border border-slate-100 dark:border-zinc-800/80 dark:bg-zinc-900 rounded-3xl p-8 shadow-xl shadow-slate-100/40 dark:shadow-none">
        ...
        <Form className="flex flex-col gap-4" onSubmit={onSubmit}>
          ...
          {/* 3. Photo URL Field */}
          <TextField isRequired name="photo" type="url" className="w-full flex flex-col gap-1.5">
            <Label className="text-xs font-semibold text-slate-700 dark:text-zinc-300">Profile Photo URL</Label>
          ...
          >
            ...
            <div className="relative w-full">
              <Input placeholder="Enter your password" className={inputClassName} />
              <button 
                type="button" 
          ...
          <div className="flex flex-col gap-2 mt-4">
            ...
            <Button type="reset" variant="light" className="w-full rounded-xl text-xs text-slate-400 dark:text-zinc-500 h-9">
              Reset Form
            </Button>
          </div>
        </Form>
